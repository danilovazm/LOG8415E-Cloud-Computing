...
pkill -f ndb_mgmd;
# Doing the configuration of management service
...
EOF
systemctl daemon-reload;                                                               # Doing the reload of the service after qthe configuration
systemctl start ndb_mgmd;
systemctl enable ndb_mgmd;
systemctl status ndb_mgmd;
sudo wget https://dev.mysql.com/get/Downloads/MySQL-Cluster-8.0/mysql-cluster_8.0.31-1ubuntu20.04_amd64.deb-bundle.tar;  # Downloading the .deb required for the installation
mkdir install;
